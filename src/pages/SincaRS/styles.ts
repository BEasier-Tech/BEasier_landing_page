...
export const AppShowcaseSection = styled(SectionBase)`
  background: #f8fafc;
  padding: 5rem 1.5rem;
`;
...
export const FeatureShowcaseCard = styled.div<{ $reverse?: boolean }>`
  display: flex;
  align-items: center;
...
export const FeatureCheckList = styled.ul`
  list-style: none;
  padding: 0;
  margin: 0 0 1.5rem 0;
  display: flex;
...
export const FeatureTipBox = styled.div`
  background: #f0fdf4;
...
export const WhatsAppChatMockup = styled.div`
  width: 100%;
  max-width: 380px;
  background: #0b141a;
  border-radius: 24px;
...
export const WhatsAppChatHeader = styled.div`
  background: #202c33;
...
export const WhatsAppChatBody = styled.div`
  background: #0b141a;
...
export const WhatsAppBubble = styled.div<{ $outgoing?: boolean }>`
  max-width: 90%;
  align-self: ${(props) => (props.$outgoing ? "flex-end" : "flex-start")};
  background: ${(props) => (props.$outgoing ? "#005c4b" : "#202c33")};
  color: #e9edef;
  ...
  .bubble-badge {
    ...
    background: ${(props) =>
      props.$outgoing ? "rgba(255,255,255,0.15)" : "rgba(59, 130, 246, 0.25)"};
    color: ${(props) => (props.$outgoing ? "#a7f3d0" : "#93c5fd")};
    font-size: 0.7rem;
    font-weight: 700;
    padding: 2px 7px;
    border-radius: 4px;
